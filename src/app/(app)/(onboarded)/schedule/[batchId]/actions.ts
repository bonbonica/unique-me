...
/**
 * Per-post Cancel and Restore server actions for `/schedule/[batchId]`.
 *
 ...
 *   4. Revalidate `/schedule/[batchId]` (this page) and `/schedule` (the box's
 *      per-network counts and `{N} posts` totals exclude `'cancelled'` rows
 *      per D-S2-21 readers).
 *
